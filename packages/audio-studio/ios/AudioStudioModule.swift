...
public class AudioStudioModule: Module, AudioStreamManagerDelegate, AudioDeviceManagerDelegate {
    ...
    public func definition() -> ModuleDefinition {
        ...
        Function("initializePlayback") { (sampleRate: Double?) in
            Logger.debug("AudioStudioModule", "initializePlayback called with sampleRate: \(sampleRate ?? 24000)")
        ...
        Function("playBuffer") { (base64Audio: String, sampleRate: Double?) in
            guard let data = Data(base64Encoded: base64Audio) else {
                Logger.error("AudioStudioModule", "playBuffer: Invalid base64 audio data")
                return
            }
        ...
        Function("stopPlayback") {
            Logger.debug("AudioStudioModule", "stopPlayback called")
        ...
        Function("clearPlaybackQueue") {
            Logger.debug("AudioStudioModule", "clearPlaybackQueue called")
        ...
        Function("cleanupPlayback") {
            Logger.debug("AudioStudioModule", "cleanupPlayback called")
        ...
        Function("setPlaybackVolume") { (volume: Float) in
            Logger.debug("AudioStudioModule", "setPlaybackVolume called with volume: \(volume)")
